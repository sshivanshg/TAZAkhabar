...
Product name placeholder: **Khabro**. Do not add a separate Vite/CRA **reader** — web is exported from Expo (`docs/adr/003-expo-universal-client.md`). Admin Vite is the narrow exception (`docs/adr/006-internal-admin-spa.md`).
