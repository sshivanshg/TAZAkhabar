...
public static class SeedData
{
    ...
    [
        new() { Id = 1, Name = "Agra", State = "Uttar Pradesh", Slug = "agra", Latitude = 27.1767, Longitude = 78.0081 },
        new() { Id = 2, Name = "Jhansi", State = "Uttar Pradesh", Slug = "jhansi", Latitude = 25.4484, Longitude = 78.5685 },
        new() { Id = 3, Name = "Kanpur", State = "Uttar Pradesh", Slug = "kanpur", Latitude = 26.4499, Longitude = 80.3319 },
        new() { Id = 4, Name = "Lucknow", State = "Uttar Pradesh", Slug = "lucknow", Latitude = 26.8467, Longitude = 80.9462 },
        // Single picker city; Gurugram / Noida / NCR places match into this feed via PlaceNameMatcher.
        new() { Id = 5, Name = "Delhi", State = "Delhi", Slug = "delhi", Latitude = 28.6139, Longitude = 77.2090 },
        new() { Id = 6, Name = "Mumbai", State = "Maharashtra", Slug = "mumbai", Latitude = 19.0760, Longitude = 72.8777 },
        new() { Id = 7, Name = "Bengaluru", State = "Karnataka", Slug = "bengaluru", Latitude = 12.9716, Longitude = 77.5946 },
        new() { Id = 8, Name = "Hyderabad", State = "Telangana", Slug = "hyderabad", Latitude = 17.3850, Longitude = 78.4867 },
        new() { Id = 9, Name = "Chennai", State = "Tamil Nadu", Slug = "chennai", Latitude = 13.0827, Longitude = 80.2707 },
        new() { Id = 10, Name = "Kolkata", State = "West Bengal", Slug = "kolkata", Latitude = 22.5726, Longitude = 88.3639 },
        new() { Id = 11, Name = "Pune", State = "Maharashtra", Slug = "pune", Latitude = 18.5204, Longitude = 73.8567 },
        new() { Id = 12, Name = "Ahmedabad", State = "Gujarat", Slug = "ahmedabad", Latitude = 23.0225, Longitude = 72.5714 },
        new() { Id = 13, Name = "Surat", State = "Gujarat", Slug = "surat", Latitude = 21.1702, Longitude = 72.8311 },
        new() { Id = 14, Name = "Jaipur", State = "Rajasthan", Slug = "jaipur", Latitude = 26.9124, Longitude = 75.7873 },
        new() { Id = 15, Name = "Chandigarh", State = "Chandigarh", Slug = "chandigarh", Latitude = 30.7333, Longitude = 76.7794 },
        new() { Id = 16, Name = "Indore", State = "Madhya Pradesh", Slug = "indore", Latitude = 22.7196, Longitude = 75.8577 },
        new() { Id = 17, Name = "Bhopal", State = "Madhya Pradesh", Slug = "bhopal", Latitude = 23.2599, Longitude = 77.4126 },
        new() { Id = 18, Name = "Patna", State = "Bihar", Slug = "patna", Latitude = 25.5941, Longitude = 85.1376 },
        new() { Id = 19, Name = "Ranchi", State = "Jharkhand", Slug = "ranchi", Latitude = 23.3441, Longitude = 85.3096 },
        new() { Id = 20, Name = "Bhubaneswar", State = "Odisha", Slug = "bhubaneswar", Latitude = 20.2961, Longitude = 85.8245 },
        new() { Id = 21, Name = "Guwahati", State = "Assam", Slug = "guwahati", Latitude = 26.1445, Longitude = 91.7362 },
        new() { Id = 22, Name = "Kochi", State = "Kerala", Slug = "kochi", Latitude = 9.9312, Longitude = 76.2673 },
        new() { Id = 23, Name = "Thiruvananthapuram", State = "Kerala", Slug = "thiruvananthapuram", Latitude = 8.5241, Longitude = 76.9366 },
        new() { Id = 24, Name = "Kozhikode", State = "Kerala", Slug = "kozhikode", Latitude = 11.2588, Longitude = 75.7804 },
        new() { Id = 25, Name = "Coimbatore", State = "Tamil Nadu", Slug = "coimbatore", Latitude = 11.0168, Longitude = 76.9558 },
        new() { Id = 26, Name = "Madurai", State = "Tamil Nadu", Slug = "madurai", Latitude = 9.9252, Longitude = 78.1198 },
        new() { Id = 27, Name = "Visakhapatnam", State = "Andhra Pradesh", Slug = "visakhapatnam", Latitude = 17.6868, Longitude = 83.2185 },
        new() { Id = 28, Name = "Vijayawada", State = "Andhra Pradesh", Slug = "vijayawada", Latitude = 16.5062, Longitude = 80.6480 },
        new() { Id = 29, Name = "Nagpur", State = "Maharashtra", Slug = "nagpur", Latitude = 21.1458, Longitude = 79.0882 },
        new() { Id = 30, Name = "Nashik", State = "Maharashtra", Slug = "nashik", Latitude = 19.9975, Longitude = 73.7898 },
        new() { Id = 31, Name = "Vadodara", State = "Gujarat", Slug = "vadodara", Latitude = 22.3072, Longitude = 73.1812 },
        new() { Id = 32, Name = "Rajkot", State = "Gujarat", Slug = "rajkot", Latitude = 22.3039, Longitude = 70.8022 },
        new() { Id = 33, Name = "Jodhpur", State = "Rajasthan", Slug = "jodhpur", Latitude = 26.2389, Longitude = 73.0243 },
        new() { Id = 34, Name = "Udaipur", State = "Rajasthan", Slug = "udaipur", Latitude = 24.5854, Longitude = 73.7125 },
        new() { Id = 35, Name = "Varanasi", State = "Uttar Pradesh", Slug = "varanasi", Latitude = 25.3176, Longitude = 82.9739 },
        new() { Id = 36, Name = "Prayagraj", State = "Uttar Pradesh", Slug = "prayagraj", Latitude = 25.4358, Longitude = 81.8463 },
        new() { Id = 37, Name = "Meerut", State = "Uttar Pradesh", Slug = "meerut", Latitude = 28.9845, Longitude = 77.7064 },
        new() { Id = 38, Name = "Bareilly", State = "Uttar Pradesh", Slug = "bareilly", Latitude = 28.3670, Longitude = 79.4304 },
        new() { Id = 39, Name = "Gorakhpur", State = "Uttar Pradesh", Slug = "gorakhpur", Latitude = 26.7606, Longitude = 83.3732 },
        new() { Id = 40, Name = "Dehradun", State = "Uttarakhand", Slug = "dehradun", Latitude = 30.3165, Longitude = 78.0322 },
        new() { Id = 41, Name = "Haridwar", State = "Uttarakhand", Slug = "haridwar", Latitude = 29.9457, Longitude = 78.1642 },
        new() { Id = 42, Name = "Shimla", State = "Himachal Pradesh", Slug = "shimla", Latitude = 31.1048, Longitude = 77.1734 },
        new() { Id = 43, Name = "Jammu", State = "Jammu and Kashmir", Slug = "jammu", Latitude = 32.7266, Longitude = 74.8570 },
        new() { Id = 44, Name = "Srinagar", State = "Jammu and Kashmir", Slug = "srinagar", Latitude = 34.0837, Longitude = 74.7973 },
        new() { Id = 45, Name = "Amritsar", State = "Punjab", Slug = "amritsar", Latitude = 31.6340, Longitude = 74.8723 },
        new() { Id = 46, Name = "Ludhiana", State = "Punjab", Slug = "ludhiana", Latitude = 30.9010, Longitude = 75.8573 },
        new() { Id = 47, Name = "Jalandhar", State = "Punjab", Slug = "jalandhar", Latitude = 31.3260, Longitude = 75.5762 },
        new() { Id = 48, Name = "Raipur", State = "Chhattisgarh", Slug = "raipur", Latitude = 21.2514, Longitude = 81.6296 },
        new() { Id = 49, Name = "Bilaspur", State = "Chhattisgarh", Slug = "bilaspur", Latitude = 22.0797, Longitude = 82.1409 },
        new() { Id = 50, Name = "Jamshedpur", State = "Jharkhand", Slug = "jamshedpur", Latitude = 22.8046, Longitude = 86.2029 },
        new() { Id = 51, Name = "Dhanbad", State = "Jharkhand", Slug = "dhanbad", Latitude = 23.7957, Longitude = 86.4304 },
        new() { Id = 52, Name = "Siliguri", State = "West Bengal", Slug = "siliguri", Latitude = 26.7271, Longitude = 88.3953 },
        new() { Id = 53, Name = "Durgapur", State = "West Bengal", Slug = "durgapur", Latitude = 23.5204, Longitude = 87.3119 },
        new() { Id = 54, Name = "Cuttack", State = "Odisha", Slug = "cuttack", Latitude = 20.4625, Longitude = 85.8830 },
        new() { Id = 55, Name = "Mangaluru", State = "Karnataka", Slug = "mangaluru", Latitude = 12.9141, Longitude = 74.8560 },
        new() { Id = 56, Name = "Mysuru", State = "Karnataka", Slug = "mysuru", Latitude = 12.2958, Longitude = 76.6394 },
        new() { Id = 57, Name = "Hubballi", State = "Karnataka", Slug = "hubballi", Latitude = 15.3647, Longitude = 75.1240 },
        new() { Id = 58, Name = "Warangal", State = "Telangana", Slug = "warangal", Latitude = 17.9689, Longitude = 79.5941 },
        new() { Id = 59, Name = "Tirupati", State = "Andhra Pradesh", Slug = "tirupati", Latitude = 13.6288, Longitude = 79.4192 },
        new() { Id = 60, Name = "Salem", State = "Tamil Nadu", Slug = "salem", Latitude = 11.6643, Longitude = 78.1460 },
        new() { Id = 61, Name = "Tiruchirappalli", State = "Tamil Nadu", Slug = "tiruchirappalli", Latitude = 10.7905, Longitude = 78.7047 },
        new() { Id = 62, Name = "Puducherry", State = "Puducherry", Slug = "puducherry", Latitude = 11.9416, Longitude = 79.8083 },
        new() { Id = 63, Name = "Panaji", State = "Goa", Slug = "panaji", Latitude = 15.4909, Longitude = 73.8278 },
        new() { Id = 64, Name = "Agartala", State = "Tripura", Slug = "agartala", Latitude = 23.8315, Longitude = 91.2868 },
        new() { Id = 65, Name = "Shillong", State = "Meghalaya", Slug = "shillong", Latitude = 25.5788, Longitude = 91.8933 },
        new() { Id = 66, Name = "Imphal", State = "Manipur", Slug = "imphal", Latitude = 24.8170, Longitude = 93.9368 },
        new() { Id = 67, Name = "Aizawl", State = "Mizoram", Slug = "aizawl", Latitude = 23.7271, Longitude = 92.7176 },
        new() { Id = 68, Name = "Kohima", State = "Nagaland", Slug = "kohima", Latitude = 25.6751, Longitude = 94.1086 },
        new() { Id = 69, Name = "Gangtok", State = "Sikkim", Slug = "gangtok", Latitude = 27.3389, Longitude = 88.6065 },
        new() { Id = 70, Name = "Itanagar", State = "Arunachal Pradesh", Slug = "itanagar", Latitude = 27.0844, Longitude = 93.6053 },
        new() { Id = 71, Name = "Port Blair", State = "Andaman and Nicobar Islands", Slug = "port-blair", Latitude = 11.6234, Longitude = 92.7265 },
        new() { Id = 72, Name = "Gurugram", State = "Haryana", Slug = "gurugram", Latitude = 28.4595, Longitude = 77.0266 },
        new() { Id = 73, Name = "Noida", State = "Uttar Pradesh", Slug = "noida", Latitude = 28.5355, Longitude = 77.3910 },
        new() { Id = 74, Name = "Ghaziabad", State = "Uttar Pradesh", Slug = "ghaziabad", Latitude = 28.6692, Longitude = 77.4538 },
        new() { Id = 75, Name = "Faridabad", State = "Haryana", Slug = "faridabad", Latitude = 28.4089, Longitude = 77.3178 },
    ];
    ...
    public static readonly Source[] IndiaExpansionSources = Cities
        .Where(city => city.Id >= 6)
        .Select(city => new Source
        {
            Id = 1000 + city.Id,
            Name = "Google News",
