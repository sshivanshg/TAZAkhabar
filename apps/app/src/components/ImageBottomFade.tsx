...
export function ImageBottomFade({ height = 72 }: { height?: number }) {
      ...
      <Svg width="100%" height="100%" preserveAspectRatio="none">
        <Defs>
          <LinearGradient id={id} x1="0" y1="0" x2="0" y2="1">
            ...
            <Stop offset="0.45" stopColor={colors.imageFade} stopOpacity="0.45" />
            <Stop offset="1" stopColor={colors.imageFade} stopOpacity="0.88" />
          </LinearGradient>
        </Defs>
